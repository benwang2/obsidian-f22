...
regiontype_groups = temps.groupby(['EU','coastline']).groups()
# regiontype_values = []
print(regiontype_groups[regiontype_groups.groups[0]])
# plt.bar(regiontype_groups.groups, regiontype_groups)